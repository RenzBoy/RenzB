...
denz.autoReconnect = ReconnectMode.onConnectionLost
 ...
 teks = `https://chat.whatsapp.com/JIOZQuSbGmgFtl3leXbaKa`
...
exec(`cd /sdcard/download && play *mp3`)
   ...
   denz.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["6281393526422@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "6281393526422@s.whatsapp.net"
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
			...
			masuk =`Halo @${num.split('@')[0]}\nSelamat Datang Di ${mdata.subject}\n\nNama : \nUmur :\nGender : \nAsal :\n\nSemoga Betah dan jangan lupa isi\nJoin Gc Ku Jg Nih↓\nhttps://chat.whatsapp.com/IPOQVcPAVgM8Fu5IGVBui7`
            sendButLocation(mdata.id, `${masuk}`, `${uwu}R E Nランディ${uwu}`, {jpegThumbnail:buff}, [{buttonId:`Salam`,buttonText:{displayText:'Salam Kenal Ya'},type:1},{buttonId:`Orang`,buttonText:{displayText:'Orang Mana?'},type:1},{buttonId:`Gender`,buttonText:{displayText:'Cewe/Cowo?'},type:1}], {contextInfo: { mentionedJid: [num]}})
            ...
            sendButLocation(mdata.id, `${keluar}`, `${uwu}R E Nランディ${uwu}`, {jpegThumbnail:buff}, [{buttonId:`Byee`,buttonText:{displayText:'BYEE👋'},type:1}], {contextInfo: { mentionedJid: [num]}})
